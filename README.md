...
Our NULL hypothesis <img src="https://render.githubusercontent.com/render/math?math=H_0"> is that variable <img src="https://render.githubusercontent.com/render/math?math=z_i"> does not cause <img src="https://render.githubusercontent.com/render/math?math=z_j">, 
<img src="https://render.githubusercontent.com/render/math?math=H_0">: <img src="https://render.githubusercontent.com/render/math?math=D_i"> != <img src="https://render.githubusercontent.com/render/math?math=D_i">, else the alternate hypothesis <img src="https://render.githubusercontent.com/render/math?math=H_1">: <img src="https://render.githubusercontent.com/render/math?math=D_i"> = <img src="https://render.githubusercontent.com/render/math?math=D_i">  is accepted.
