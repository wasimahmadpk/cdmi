...
4. We perform KS test over distribution <img src="https://render.githubusercontent.com/render/math?math=D_i">, <img src="https://render.githubusercontent.com/render/math?math=D_j"> of model residuals in various environments. Our NULL hypothesis is that variable zi does not cause zj, 
<img src="https://render.githubusercontent.com/render/math?math=D_i">: <img src="https://render.githubusercontent.com/render/math?math=D_k^{i\checkmark}">
