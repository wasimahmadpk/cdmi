    ...
    def generate_data(self):
        ...
        for t in range(11, self.time_steps):
            ...
            if t < self.time_steps/3:
                ...
                self.X3.append(C.get('c2') ** ((self.X1[t - Tao.get('t3')]) / 2) + ez[t])
                self.X4.append(C.get('c3') * self.X1[t - Tao.get('t1')] + ex[t])
                self.X5.append(C.get('c5') * self.X4[t - Tao.get('t4')] + C.get('c3') * self.X1[t - Tao.get('t3')] + ey[t])
                ...
                self.X5.append(C.get('c4') * self.X4[t - Tao.get('t1')] + C.get('c3') * self.X1[t - Tao.get('t1')] + ey[t])
                ...
                self.X4.append(C.get('c3') * self.X1[t - Tao.get('t2')] + ex[t])
                self.X5.append(C.get('c2') * self.X4[t - Tao.get('t1')] + C.get('c3') * self.X1[t - Tao.get('t3')] + ey[t])
...
if __name__ == '__main__':
    ...
    time_steps, Tref = 1111, 15

    ex = np.random.normal(0, 0.15, time_steps)
    ey = np.random.normal(0, 0.05, time_steps)
    ez = np.random.normal(0, 0.10, time_steps)

    C = {'c1': 0.95, 'c2': 1.25, 'c3': 0.85, 'c4': 1.00, 'c5': 1.11}           # c2:1.75, c5:1.85
