...
def load_geo_data():
    ...
    #    'tides_ew', 'tides_ns']
    vars = ['DateTime', 'gw_mb', 'gw_sg', 'gw_west', 'gw_south', 'strain_ew_corrected', 'strain_ns_corrected']
    # vars = ['DateTime', 'temperature_outside', 'pressure_outside', 'wind_x', 'wind_y', 'strain_ew_corrected', 'strain_ns_corrected']
